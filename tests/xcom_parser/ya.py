'''
    Да
    Каталог магазина xcom
    https://www.xcom-shop.ru/var/export/market_all.yml
    преобразует xml --> excel файлы
...
yaml_abs_file_name = 'C:/Users/G.Tishchenko/downloads/market_all.yml'
xlsx_file = desctop_path + 'm_all_cats.xlsx'
print("Открываем файл...")
# yaml.warnings({'YAMLLoadWarning': False})
# with open(yaml_file, "r", encoding = 'utf8|') as stream:
with open(yaml_abs_file_name, "r+", encoding = 'utf8') as stream:
    ...
    #     data = yaml.load(stream, Loader = yaml.FullLoader)
    print('создание экземляра "BeautifulSoup"')
