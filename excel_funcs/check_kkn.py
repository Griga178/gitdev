"""
сравнение характеристик ККН с КТРУ одной версией
"""
...
def check_reestr(ktru_set: Tuple[str, ...],
    ...
    for kkn in reestr_kkn:
        ...
        for kkn_char in kkn_chars:
            ...
            if ktru_char:
                ...
                kkn_char['ktru_data'] = {
                    ...
                    'ktru_chars_origin': ktru_char.get('values', []),
                }
            else:
        ...
        # Нужно добавить требуемые обязательные характеристики из КТРУ
        for char in ktru_chars_dict.values():
            if char.get('isRequired', False):
                ...
                char['ktru_data'] = {
                    ...
                    'errors': char_values,
                    'is_required': True,
                    'ktru_chars_origin': char.get('values', []),
                }
