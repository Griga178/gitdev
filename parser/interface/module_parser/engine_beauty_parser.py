...
from engine_parser_addition import clean_number, clean_text, set_true, set_current_date
...
def run_beautiful_parser(settings):
    ...
    for link_id, link in settings['links'].items():
        ...
        try:
            ...
            print('Не получить html страницу')
            break
...
def html_searcher(tag_setting, for_soup):
    ...
    desired_info = {'price': clean_number, 'name': clean_text, 'sold_out': set_true}
