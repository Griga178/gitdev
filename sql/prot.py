...
- распределить на типы по ценам и другим
 влиятельным характеристикам - функция (дисперсия вариация, "м.б. другая категория")
- отобразить нужное на сайте (список прототипов на сайте с сылками на их
    характеристики, категория, созданная на их основе)
'''
